...
export const pestle = ['Economic', 'Environmental', 'Social', 'Industries', 'Political', 'Technological', 'Organization', 'Healthcare', 'Lifestyles'];

export const source = ['Wikipedia', 'Bloomberg Business', 'CNBC ', 'Engineering News', 'IHS Engineering 360', 'Europe in My Region', 'Rigzone', 'CNNMoney', 'Foreign Policy', 'UNEP', 'Imeche', 'McKinsey & Company', 'energy news cyprus', 'uschamber', 'Infracircle', 'Oil and Gas Journal', 'Face2face Africa', 'The American Prospect', 'Washington Post', 'marketrealist', 'EPS News', 'dailytexanonline', 'Australian Government', 'conferenceseries', 'greenerearthnews'];

export const country = ['United States of America', 'Poland', 'Belize', 'Cyprus', 'India', 'Nigeria', 'Canada', 'Indonesia', 'Iraq', 'Syria', 'China', 'Libya', 'Iran', 'Egypt', 'Ghana', 'Mexico', 'United Kingdom', 'Russia', 'Turkey', 'Japan', 'Venezuela', 'Algeria', 'Saudi Arabia', 'Jordan'];