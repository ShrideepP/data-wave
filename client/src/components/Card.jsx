...
const Card = ({ title, percentage }) => {
    ...
    return (
        <div className='grid place-items-center text-center inner-space bg-secondary dark:bg-dark-secondary border border-tirtiary dark:border-dark-tirtiary rounded-sm shadow-lg'>
