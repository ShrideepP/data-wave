...
const Header = () => {
  ...
  return (
    <nav className="w-full h-fit relative z-50 horizontal-space bg-secondary dark:bg-dark-secondary border-b-2 border-tirtiary dark:border-dark-tirtiary shadow-lg">
